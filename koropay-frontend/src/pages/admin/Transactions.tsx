...
export default function Transactions() {
  ...
  const filtered = mockTransactions.filter(tx => {
    const matchSearch = tx.passengerName.toLowerCase().includes(search.toLowerCase());
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <motion.div
        ...
        className="flex items-center justify-between px-6 py-3 glass-card mb-4"
      >
        <span className="text-sm text-surface-200/50">{filtered.length} transactions</span>
